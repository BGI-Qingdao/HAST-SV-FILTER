...
' ${vcffile} | awk '$8 ~ /DEL/{print $0}' >${prefix}.del.vcf
...
' ${vcffile} | awk '$8 ~ /INS/{print $0}' >${prefix}.ins.vcf
...
' ${prefix}.del.vcf >${prefix}.del.clean.vcf
...
do
  ...
  #V1.2
  #echo "
  #samtools view -b -F 2304 ${bamfile} ${ch_id}:${_start_upstream}-${_end_downstream}
  #" >>${index}.process_log
  #samtools view -b -F 2304 ${bamfile} ${ch_id}:${_start_upstream}-${_end_downstream} >${index}.${prefix}.bam
  #echo "
  #samtools depth ${index}.${prefix}.bam
  #" >>${index}.process_log
  #samtools depth ${index}.${prefix}.bam >${index}.${prefix}.cov
  echo "
...
' a=$a ${prefix}.del.bed >${a}.${prefix}.del.bed
}
...
echo "
java -jar ${src}/extract.jar ${prefix}.del.filtered.bed ${prefix}.del.clean.vcf
"
java -jar ${src}/extract.jar ${prefix}.del.filtered.bed ${prefix}.del.clean.vcf >${prefix}.del.filtered.vcf
